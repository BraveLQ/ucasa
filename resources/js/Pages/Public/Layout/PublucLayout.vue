    ...
    <div class="flex">
        <div class="h-screen relative fixed">
            ...
            <aside class="h-full w-16 flex flex-col space-y-10 items-center justify-center  bg-gray-800 text-white">
                ...
                <Link v-if="$page.props.auth.user.roles.includes('admin')" :href="route('dashboard')">
                    <!-- Profile -->
                    <div
                        class="h-10 w-10 flex items-center justify-center rounded-lg cursor-pointer hover:text-gray-800 hover:bg-white  hover:duration-300 hover:ease-linear focus:bg-white">
                    ...
                    <button type="submit">
                        <div
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path stroke-width="1" stroke="currentColor" d="M15.612 13.115C15.612 13.3802 15.5066 13.6346 15.3191 13.8221C15.1315 14.0097 14.8772 14.115 14.612 14.115H9.75597C9.73297 14.471 9.70397 14.825 9.66997 15.181L9.63997 15.486C9.6288 15.601 9.59006 15.7115 9.52705 15.8083C9.46403 15.9051 9.37861 15.9852 9.27801 16.042C9.17741 16.0987 9.06461 16.1303 8.94918 16.1342C8.83376 16.138 8.71911 16.1139 8.61497 16.064C6.78695 15.1879 5.13208 13.989 3.72997 12.525L3.69997 12.494C3.57125 12.3598 3.49939 12.181 3.49939 11.995C3.49939 11.809 3.57125 11.6303 3.69997 11.496L3.72997 11.465C5.13207 10.001 6.78693 8.80211 8.61497 7.92602C8.71911 7.87609 8.83376 7.85203 8.94918 7.85587C9.06461 7.8597 9.17741 7.89133 9.27801 7.94805C9.37861 8.00478 9.46403 8.08494 9.52705 8.18172C9.59006 8.27851 9.6288 8.38907 9.63997 8.50402L9.66997 8.80902C9.70397 9.16402 9.73297 9.51902 9.75597 9.87502H14.612C14.8772 9.87502 15.1315 9.98037 15.3191 10.1679C15.5066 10.3554 15.612 10.6098 15.612 10.875V13.115Z" fill="white"/>
                            </svg>
                        </div>
                    </button>
